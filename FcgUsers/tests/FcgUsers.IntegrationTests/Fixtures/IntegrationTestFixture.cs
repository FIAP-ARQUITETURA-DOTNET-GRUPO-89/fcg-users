...
public class IntegrationTestFixture : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        var builder = await DistributedApplicationTestingBuilder
            .CreateAsync<Projects.FcgUsers_AppHost>();
    ...
    public HttpClient CreateClient()
        => App.CreateHttpClient("fcgusers-api", endpointName: "https");

    /// <summary>
    /// Executa uma ação com um <see cref="FcgUsersDbContext"/> apontando para o banco de testes
    /// </summary>
    public async Task ExecuteDbContextAsync(Func<FcgUsersDbContext, Task> action)
    {
